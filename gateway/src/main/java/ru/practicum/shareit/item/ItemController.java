...
public class ItemController {
    ...
    @GetMapping
    public ResponseEntity<Object> getUserItems(@RequestHeader(Constants.USER_ID) int userId) {
    ...
    @PostMapping
    public ResponseEntity<Object> postItem(@RequestHeader(Constants.USER_ID) int userId,
