...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<Object> create(@RequestHeader(Constants.USER_ID) int userId,
    ...
    public ResponseEntity<Object> getBookingById(@RequestHeader(Constants.USER_ID) int userId,
